...
const MainContent = () => {
  return (
    <div className = "center">
                    ...
                    <h1>History</h1>
                        <p>The world of Vrioska is, by most scholars' estimation, approximately one thousand years old, with the earliest historical record being dated 773 <a href="./html_pages/timekeeping.html">PB</a>.
                            The name 'Vrioska' is used to collectively refer to the four Inner Planes (TODO: Link to Inner Planes) and the cultures therein.</p>
                        ...
                        <h2>Cosmology</h2>
                            ...
                            <ol>
                                <li>There exists/once existed an initial creator(s) who is responsible for creating the Four Planes and the Rift</li>
                                ...
                                <li>These children engaged in a bloody conflict (motivations vary but the most commonly agreed upon is to claim the slain child's power as one's own) that killed all but three of them. The three are <em>always </em>
                                    as follows:
                                    <ul>
                                        <li>Yal'da-Baoth: Lord of Flesh | The Scarlet King | The Vermillion Lord (TODO: Link to Yal'da-Baoth)</li>
                                        <li>Alagadda: Lord of Illusions | The Violet King | The Silent King (TODO: Link to Alagadda)</li>
                                        <li>Eberron: Lord of Order | The Yellow King | The Great Equalizer (TODO: Link to Eberron)</li>
                                    </ul>
                                </li>
                    ...
                    <h1>Infrastructure</h1>
                        ...
                        <h2>Ocean Worlds</h2>
                            <p>With the exception of the Shadowfell, all the planes are predominatly covered by oceans.</p>
