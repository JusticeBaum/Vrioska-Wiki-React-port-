...
import { Route, Routes, useLocation, HashRouter as Router } from 'react-router-dom'; // Updated import
...
const players = [
  ...
  { name: "Neomona", component: Neomona },
  { name: 'Ortlen', component: Ortlen },
  { name: 'Percy', component: Percy },
  { name: 'Rosen', component: Rosen },
  { name: 'Sabellax', component: Sabellax }
];

const nations = [
  { name: 'Dundax', component: Dundax }
];

const settlements = [
  { name: "Aberdeen", component: Aberdeen },
  { name: "Icarus", component: Icarus }
];

const misc = [
  { name: 'Time', component: Time },
  { name: 'Inner_Planes', component: InnerPlanes },
  { name: 'One_True_War', component: OneTrueWar },
  { name: "Yal'Da-Baoth", component: YalDaBaoth },
  { name: "Alagadda", component: Alagadda },
  { name: "Eberron", component: Eberron }
];
